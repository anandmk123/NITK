...
void insertionSort(int arr[], int n, long long *comparisonCount)
{
    int i, j, key;
    *comparisonCount = 0; // Initialize comparison counter
    ...
    for (i = 1; i < n; i++)
    {
        ...
        // Count comparisons in this loop
        while (j >= 0 && arr[j] > key)
        {
            (*comparisonCount)++;
            arr[j + 1] = arr[j];
        ...
        // Final comparison when j < 0 or arr[j] <= key
        if (j >= 0)
        {
            (*comparisonCount)++;
        }
...
int main()
{
    ...
    for (int j = 0; j < 10; j++)
    {
        ...
        insertionSort(arr, n, &comparisonCount);
    ...
    FILE *fp3 = fopen("./comparison/SortedInsertioncomparison", "w");
    if (fp3 == NULL)
    {
        printf("Not able to open the output file");
        return 0;
    ...
    FILE *fp4 = fopen("./comparison/DescendInsertioncomparison", "w");
    if (fp4 == NULL)
    {
        printf("Not able to open the output file");
        return 0;
    ...
    FILE *fp5 = fopen("./comparison/RandomInsertioncomparison", "w");
    if (fp5 == NULL)
    {
        printf("Not able to open the output file");
        return 0;
